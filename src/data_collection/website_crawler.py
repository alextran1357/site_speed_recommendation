"""Collect up to ten internal pages per website from the configured URL list."""
...
INPUT_PATH = VOLUME_PATH / "website_list_v6.txt"
OUTPUT_PATH = VOLUME_PATH / "collected_urls_v6.json"
...
def crawl_domain(start_url, max_pages=PAGE_LIMIT):
    ...
    while urls_to_visit and len(collected_urls) < max_pages:
        ...
        for link in soup.find_all("a", href=True):
            ...
            if is_valid_url(new_url) and is_html_url(new_url) and is_internal_link(domain, new_url):
